# ==============================================================================
# Script: A4_1_Blood_relation_mediation.R
# Project: Lifespan Resilience Modeling (STM Submission)
# Purpose: Investigate multivariable associations and mediation effects of peripheral blood count and biochemistry biomarkers linking trauma exposure and resilience.
# ==============================================================================
...
write.csv(mediation_results_table,
          "results/blood_mediation_data_20251023.csv",
          row.names = FALSE)
