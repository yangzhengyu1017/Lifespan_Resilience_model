# ==============================================================================
# Script: A6_1_IMAGEN_resilience_model.R
# Project: Lifespan Resilience Modeling (STM Submission)
# Purpose: Validate UK Biobank-derived resilience model in the longitudinal adolescent IMAGEN cohort (ages 14-22), modeling internalizing disorder trajectories and non-inferiority odds ratios.
# ==============================================================================
...
# Load data
# ================================
resilience_corr_rename_dat <- read.csv("data/UKB_dat_for_resilience_model_1224.csv")
IMAGEN_test_dat <- read.csv("data/IMAGEN_test_dat.csv")
trauma_dat <- read.csv("data/IMAGEN_trauma_dat.csv")
