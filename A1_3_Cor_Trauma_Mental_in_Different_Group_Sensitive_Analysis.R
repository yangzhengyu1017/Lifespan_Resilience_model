...
# Merge with trauma and mental health variables
...
resilience_group_R <- resilience_group_R %>%
  ...
  mutate(Ethnic_group = Ethnic_group - 1)
...
lme_BL <- lm(
  PHQ_BL ~ self_resilience * Trauma_exposure + Age + Sex + Ethnic + BMI + Education,
...
# Linear regression: interaction of continuous resilience and trauma
lme_FU1 <- lm(
  Mental_symptom_scores_FU1 ~ self_resilience * Trauma_exposure + Age + Sex + Ethnic + BMI + Education,
...
# Linear regression: interaction of continuous resilience and trauma
lme_FU2 <- lm(
  Mental_symptom_scores_FU2 ~ self_resilience * Trauma_exposure + Age + Sex + Ethnic + BMI + Education,
