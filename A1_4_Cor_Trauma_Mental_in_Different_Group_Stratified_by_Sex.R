# ==============================================================================
# Script: A1_4_Cor_Trauma_Mental_in_Different_Group_Stratified_by_Sex_V2.R
# Project: Lifespan Resilience Modeling (STM Submission)
# Purpose: Conduct sex-stratified subgroup analyses of trauma-mental health correlations across resilience groups at Baseline, FU1, and FU2.
# ==============================================================================
...
resilience_group_R_FU1$FU1_symptoms <- ((resilience_group_R_FU1$PHQ9_Severity_FU1 -1)/27 + 
...
resilience_group_R_FU2$FU2_symptoms <- (resilience_group_R_FU2$`PHQ-9_FU2`/27 +
