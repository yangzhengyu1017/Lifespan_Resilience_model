# ==============================================================================
# Script: A4_5_Proteinic_relation_mediation.R
# Project: Lifespan Resilience Modeling (STM Submission)
# Purpose: Analyze multivariable associations of Olink plasma proteomic biomarkers with trauma, depression (PHQ), and resilience, performing formal mediation tests.
# ==============================================================================
...
write.csv(trauma_result_table,
          "results/trauma_result_table.csv",
          row.names = FALSE)
...
write.csv(PHQ_results_table,
          "results/blood_protein_PHQ_results_table.csv",
          row.names = FALSE)
...
write.csv(both_results_adj,
          "results/blood_protein_both_result.csv",
          row.names = FALSE)
...
write.csv(R_results_table,
          "results/R_results_table_protein.csv",
          row.names = FALSE)
...
write.csv(mediation_results_table,
          "data/protein_mediation_data.csv",
          row.names = FALSE)
