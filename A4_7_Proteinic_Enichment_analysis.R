# ==============================================================================
# Script: A4_7_Proteinic_Enichment_analysis.R
# Project: Lifespan Resilience Modeling (STM Submission)
# Purpose: Perform Gene Ontology (GO), KEGG, and Reactome pathway enrichment analyses on significant resilience-mediating proteomic biomarkers.
# ==============================================================================
...
resilience_group_R <- read.csv("data/resilience_group_R.csv")
...
file_path <- "data/protein_mediation_data.csv"
